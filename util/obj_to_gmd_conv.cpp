/*!
  ...
  @brief
  Program to convert .obj files to the .gmd (Gumshoe Engine Model) format.

  @detail
  This program will parse a .obj model and convert it to a .gmd model, for use with the Gumshoe Engine.
*/
