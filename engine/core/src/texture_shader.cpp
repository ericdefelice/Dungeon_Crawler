...
bool TextureShader::Init(ID3D11Device* device, HWND hwnd)
{
    ...
    LPCSTR vsFilename = (LPCSTR)"../engine/core/inc/shaders/texture.vs";
    LPCSTR psFilename = (LPCSTR)"../engine/core/inc/shaders/texture.ps";
...
void TextureShader::OutputShaderErrorMessage(ID3D10Blob* errorMessage, HWND hwnd, LPCSTR* shaderFilename)
{
	char* compileErrors;
	uint32 bufferSize, i;
	ofstream fout;
